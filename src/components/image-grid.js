...
const ImageGrid = ({ data }) => {
  ...
  slides.push(
    <div className="flex flex-col items-start my-4 md:my-12" key={e.id}>
      <figure className="slide-icon mb-8 w-4/12 md:w-2/12 ml-4">
        ...
        <h4 className="text-center font-bodyMedium">
          {e.title}
        </h4>
...
return(
 <section className="mb-12 image-grid">
   <div className="mx-4 lg:mx-auto w-4/5">
   ...
   <div className="grid col-gap-0 row-gap-0 md:col-gap-16 md:row-gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mb-16">
    {slides}
   </div>
   </div>
 </section>
