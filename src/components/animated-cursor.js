...
const AnimatedCursor = ({location}) => {
  ...
  return (
    <div>
      <div ref={cursorOuterRef} style={styles.cursorOuter} className="inline-flex justify-center items-center" ><span className={`${isActive ? 'block' : 'hidden'} transform scale-50 font-display text-white`}> Open</span></div>
