        ...
        <div className="w-full m-auto">
          <div className="flex flex-col items-center">
            <figure className="w-full md:w-48 xl:w-64">
              <img
                src={
                  ...
                  "/uploads/about_questions_07_c63204d7ea.svg"
                }
                alt=""
              />
            </figure>
            <h3 className="section-title text-6xl thankyou-text">
              Thank You !
            </h3>
            <p className="tracking-body mb-5 pb-5 md:mb-0 md:pb-0 font-bodyMedium text-gray-100 text-2xl text-center w-full  md:w-8/12 my-4 leading-tight">
              ...
              <span className="block">our team will reach you in no time</span>
            </p>
            <Link
              className="link-button text-xl my-4 hover:text-blue-100"
              to="/"
            >
              back to homepage
            </Link>
          ...
          <div className="flex flex-col md:flex-row justify-between mx-4 my-4 md:mx-8 md:my-12">
            <div>
              <Link
                to="/contact-us"
                className="mr-0 mb-4 md:mb-0 md:mr-8 underline block md:inline-block"
              >
                Contact
              </Link>
